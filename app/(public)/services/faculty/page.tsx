...
import { CheckCircle2, Award, BookOpen, Target, Users, FileText, Microscope } from "lucide-react"
      ...
      <section className="relative h-[35vh] flex items-end overflow-hidden">
        ...
        <div className="container relative z-10 pb-12">
           <div className="flex items-center gap-4 mb-4">
              ...
              <h4 className="text-secondary font-bold uppercase tracking-widest text-[10px] font-sans">Research & Development</h4>
            </div>
          <h1 className="text-2xl md:text-4xl font-bold text-white font-serif uppercase tracking-tight">Faculty Advancement</h1>
        </div>
      </section>
