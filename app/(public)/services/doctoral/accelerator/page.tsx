...
export default function acceleratorWeekend() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Weekend Schedule */}
      <section className="py-24 container max-w-7xl px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
           <div className="space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold text-primary font-serif uppercase tracking-tight leading-tight italic">The Accelerator Experience</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 pt-8">
                 <div className="p-8 bg-slate-50 elevated-card border-t-4 border-secondary rounded-none">
                    <Target className="w-10 h-10 text-primary mb-6" />
                    <h3 className="text-lg font-extrabold text-primary uppercase tracking-widest mb-3 font-sans">Day 1: Clarity</h3>
                    <p className="text-sm text-slate-500 font-light leading-relaxed">Identify your core argument and map your full chapter structure. Leave knowing exactly what needs to be written.</p>
                 </div>
                 <div className="p-8 bg-primary text-white elevated-card border-t-4 border-secondary rounded-none shadow-2xl">
                    <Rocket className="w-10 h-10 text-secondary mb-6" />
                    <h3 className="text-lg font-extrabold uppercase tracking-widest mb-3 font-sans text-white">Day 2: Momentum</h3>
                    <p className="text-sm opacity-80 font-light leading-relaxed">Build your writing plan, set 30-day milestones, and do a live working session to leave with actual progress.</p>
                 </div>
              </div>
           </div>

           <div className="bg-[#0a192f] p-12 text-white relative shadow-2xl overflow-hidden group rounded-none">
              ...
              <h3 className="text-xl font-bold uppercase tracking-widest mb-8 border-b border-white/10 pb-4 font-sans">Who Should Attend</h3>
