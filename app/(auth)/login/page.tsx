...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // No redirect config here because Supabase handles redirect to our callback API
  }
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-muted/20 pb-20">
      ...
      <div className="max-w-md w-full p-8 bg-card border rounded-2xl shadow-xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <Button className="w-full mt-6" size="lg" disabled={loading || googleLoading}>
            {loading ? (
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/register" className="text-primary font-semibold hover:text-secondary transition-colors">
            Sign up
          </Link>
        </p>
      </div>
