    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden pt-24 pb-32">
        ...
        <div className="container relative z-10 text-center max-w-5xl flex-1 flex flex-col justify-center">
          ...
          <Reveal delay={0.3} className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          ...
          <Reveal delay={0.4} direction="up" className="text-center text-white hidden md:block pt-8 border-t border-white/20 max-w-3xl mx-auto">
      ...
      <section className="relative z-20 container max-w-7xl pb-16">
        <div className="grid md:grid-cols-3 gap-8 md:-mt-24 -mt-4">
          <Reveal delay={0.5}>
            <Link href="/services/doctoral" className="bg-white elevated-card p-6 md:p-10 flex flex-col items-center text-center group cursor-pointer h-full">
          ...
          <Reveal delay={0.6}>
            <Link href="/services/faculty" className="bg-white elevated-card p-6 md:p-10 flex flex-col items-center text-center group cursor-pointer border-t-4 border-t-secondary h-full">
          ...
          <Reveal delay={0.7}>
            <Link href="/services/leadership" className="bg-white elevated-card p-6 md:p-10 flex flex-col items-center text-center group cursor-pointer h-full">
      ...
      <section className="py-12 container max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <Reveal key={idx} delay={0.2 + idx * 0.1}>
                  <div className="bg-white elevated-card p-6 group h-full">
            ...
            <Reveal delay={0.6}>
              <Link href="/services/doctoral" className="mt-8 inline-flex text-primary font-bold uppercase tracking-widest items-center hover:text-secondary transition-colors text-sm">
                Explore Our Services <ChevronRight className="w-4 h-4 ml-1" />
              </Link>
            </Reveal>
          </div>
          <Reveal direction="left" delay={0.3} className="relative h-[600px] w-full mt-10 lg:mt-0">
